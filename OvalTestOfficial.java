...
public class OvalTestOfficial
{
    ...
    public void testOvalConstructorPoint()
    {
        ...
        // TODO: implement this.
        Assert.assertEquals("Wrong point", new Point(100, 100), o1.getLocation()[0]);
        Assert.assertEquals("Wrong point", new Point(100, 100), o2.getLocation()[0]);
        Assert.assertEquals("Wrong point", new Point(200, 300), c1.getLocation()[0]);
        Assert.assertEquals("Wrong point", new Point(200, 300), c2.getLocation()[0]);
